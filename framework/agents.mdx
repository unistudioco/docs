...
<Card title="Download Agent Skills (.zip)" icon="file-zipper" iconType="duotone" href="/assets/skills.zip" horizontal>
...
<AccordionGroup>
  ...
  <Accordion title="Workflow & Debugging" icon="bug" iconType="duotone">
    ...
    - **mintlify**: Guidelines for maintaining the documentation (this very site!).
  </Accordion>
</AccordionGroup>
