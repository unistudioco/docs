...
<Steps>
  <Step title="Scaffold a New Project">
    ...
    If you prefer to set up the project manually, you can clone the Squeditor Framework repository via:
    ...
    ```bash > Terminal
    node squeditor-framework/scripts/scaffold.js your-project-name
    ```
