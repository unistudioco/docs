---
title: "Introduction"
description: "Welcome to Squeditor Framework — a fully featured static HTML framework."
---
...
<Columns cols={2}>
  <Card
    ...
    href="/framework/getting-started/quickstart"
  >
    Get started with Squeditor Framework.
  </Card>
  <Card
    title="Squeditor Config"
    icon="settings"
    href="/framework/getting-started/squeditor-config"
  >
    Configure Squeditor Framework.
  </Card>
    <Card
    title="Build Pipeline"
    icon="blocks"
    href="/framework/getting-started/build-pipeline"
  >
    Build Squeditor Framework.
  </Card>
  <Card
    title="Deployment"
    icon="rocket"
    href="/framework/getting-started/deployment"
  >
    Deploy Squeditor Framework.
  </Card>
</Columns>

## Key Features
<CardGroup cols={2}>
  <Card title="Zero-Runtime PHP Templating" icon="square-dashed-bottom-code">
  </Card>
  <Card title="Token-Based Styling Architecture" icon="swatch-book">
  </Card>
  <Card title="TailwindCSS Foundation" icon="container">
  </Card>
  <Card title="Selective UIKit 3 Integration" icon="bolt">
  </Card>
  <Card title="Blazing Fast Build Pipeline" icon="blocks">
  </Card>
  <Card title="Separate Compiled Files" icon="file-code">
  </Card>
  <Card title="Shareable Deliverables" icon="shapes">
  </Card>
  <Card title="Built-in Light/Dark Mode" icon="moon">
  </Card>
  <Card title="Section-Based Workflow" icon="layers-2">
  </Card>
  <Card title="Automatic Style Guide" icon="book-open">
  </Card>
</CardGroup>
