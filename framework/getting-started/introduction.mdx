...
<div className="relative overflow-hidden">
  ...
  <div className="relative z-10 px-4 pt-16 lg:pt-[89px] max-w-3xl mx-auto text-center">
    <div className="w-fit mx-auto mb-8">
      <img src="/logo/framework-intro-light.svg" alt="Framework" className="w-[80px] h-[80px] dark:hidden" noZoom />
      <img src="/logo/framework-intro-dark.svg" alt="Framework" className="w-[80px] h-[80px] hidden dark:block" noZoom />
    </div>
  ...
  <div className="relative z-10 px-4 py-16 max-w-3xl mx-auto">
    ...
    <CardGroup cols={2}>
      ...
      <Card href="/framework/getting-started/squeditor-config" arrow="true" title="Squeditor Config" icon="folder-gear" iconType="duotone">
      </Card>
  ...
  <div className="relative z-10 px-4 pb-16 lg:pb-28 max-w-3xl mx-auto">
    <h3 className="block text-xl font-medium text-center text-gray-900 dark:text-zinc-50 tracking-tight mb-8"> Key Features</h3>
    <CardGroup cols={2}>
